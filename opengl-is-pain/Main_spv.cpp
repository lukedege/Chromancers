...
//	
//	// Shader setup
//	ugl::Shader lightShader{"shaders/spv/buny.vert.spv", "shaders/spv/buny.frag.spv"};
//	//ugl::Shader lightShader{ "shaders/procedural_base.vert", "shaders/illumination_models.frag" };
//
//	// Camera setup
...
//
//	// UBO setup
//	GLuint ubo_cam_matrices, ubo_obj_matrices, ubo_lights_amount, ubo_lights_data, ubo_shading_attrs;
//	
//	ugl::setup_buffer_object(ubo_cam_matrices , GL_UNIFORM_BUFFER, 0, 0, sizeof(glm::mat4) * 2);
//	ugl::setup_buffer_object(ubo_obj_matrices , GL_UNIFORM_BUFFER, 1, 0, sizeof(glm::mat4) + sizeof(glm::mat3));
//	ugl::setup_buffer_object(ubo_lights_amount, GL_UNIFORM_BUFFER, 2, 0, sizeof(GLuint) * 3);
//	ugl::setup_buffer_object(ubo_lights_data  , GL_UNIFORM_BUFFER, 3, 0, ugl::PointLight::shader_sizeof() * MAX_POINT_LIGHTS); // TODO to extend with spot and dir lights
//	ugl::setup_buffer_object(ubo_shading_attrs, GL_UNIFORM_BUFFER, 4, 0, sizeof(glm::vec3) * 3 + sizeof(float) * 6);
//
//	// Fixed UBOs
...
//	GLuint x = pointLights.size();
//	ugl::update_buffer_object(ubo_lights_amount, GL_UNIFORM_BUFFER, 0, sizeof(GLuint), 1, (void*)&x);
//	ugl::update_buffer_object(ubo_shading_attrs, GL_UNIFORM_BUFFER, 0, sizeof(glm::vec3), shading_attrs_colors.size(), (void*)shading_attrs_colors.data());
//	ugl::update_buffer_object(ubo_shading_attrs, GL_UNIFORM_BUFFER, sizeof(glm::vec3) * 3, sizeof(float), shading_attrs_coeff.size(), (void*)shading_attrs_coeff.data());
//
...
//		{
//			pointLights[i].setup(ubo_lights_data, i);
//		}
//		
//		// OBJECTS
//		ws = wdw.get_size();
