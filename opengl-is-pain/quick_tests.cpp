...
int mainz()
{
    ...
    //Shader tex_depth_shader{ "shaders/temp/tex.vert" , "shaders/temp/tex.frag", 4, 3 };
    //Shader shadowmap_shader{ "shaders/temp/shadow.vert" , "shaders/temp/shadow.frag", 4, 3 };
    ...
    // load textures
    // -------------
    unsigned int woodTexture = loadTexture("textures/brickwall.jpg");
    ...
    tex_depth_shader.setInt("depthMap", 0);
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        // ---------------------------------------------
        tex_depth_shader.bind();
        tex_depth_shader.setFloat("near_plane", near_plane);
        tex_depth_shader.setFloat("far_plane", far_plane);
        glActiveTexture(GL_TEXTURE0);
        glBindTexture(GL_TEXTURE_2D, depthMap);
        renderQuad();
